...
<head>
  <meta charset="utf-8">
  <title>RoyalWedding Party</title>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll" href="#page-top">Royal Wedding Planner</a>
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="intro-title mb-4">Royal Wedding Planner</h1>
          ...
          <div id="testimonial-mf" class="owl-carousel owl-theme">
            <div class="testimonial-box">
              <div class="author-test">
                ...
                <span class="author">clients1 </span>
              </div>
            ...
            <div class="testimonial-box">
              <div class="author-test">
                ...
                <span class="author">clients2</span>
              </div>
              <div class="content-test">
                <p class="description lead">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="more-info">
                    ...
                    <ul class="list-ico">
                      <li><span class="ion-ios-location"></span>gudiyatham</li>
                      <li><span class="ion-ios-telephone"></span> 0416-2256145</li>
                      <li><span class="ion-email"></span> gudiyatham@gmail.com</li>
                    </ul>
                  </div>
                  <div class="socials">
                    <ul>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="copyright-box">
              <p class="copyright">&copy; Copyright <strong>Royal Wedding Planner</strong>. All Rights Reserved</p>
              <div class="credits">
                <!--
