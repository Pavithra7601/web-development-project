<?php
  ...
  if(!isset($_SESSION['uname'])){
	...
	if(isset($_POST['cardnumberreg_id'])) { 
		$sql = "UPDATE registration SET payst='1' WHERE reg_id='".$_POST['cardnumberreg_id']."'";
...
<head>
  <meta charset="utf-8">
  <title>Royal Wedding Party</title>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll" href="#page-top">Royal Wedding Party</a>
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="intro-title mb-4">Royal Wedding Party</h1>
              ...
              $sum=$price1+$price2+$price3+$price4+$price5+$price6+$s; 
                echo " <div class='row'>
                        ...
                        <div class='col-md-2'><h5>$sum</h5></div>
                         <div class='col-md-1'>
							<div class='btn btn-outline-danger del' rid='$reg_id'>Cancle</div>";
				if($payst == 0) {
					echo "<div class='btn btn-outline-primary' rrid='$reg_id' onclick='return paynowshow($reg_id);'>Pay Now</div>";
				} else {
					echo "<br><span style='color:green'><b>Already Paid</b></span>";
				}
          ...
          <div id="testimonial-mf" class="owl-carousel owl-theme">
            <div class="testimonial-box">
              <div class="author-test">
                ...
                <span class="author">Happy Clients1</span>
              </div>
            ...
            <div class="testimonial-box">
              <div class="author-test">
                ...
                <span class="author">Happy Clients2/span>
              </div>
              <div class="content-test">
                <p class="description lead">
            ...
            <div id="contact" class="box-shadow-full">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="more-info">
                    <p class="lead">
                      Abirami college of Arts & Science
                     </p>
                    <ul class="list-ico">
                      <li><span class="ion-ios-location"></span>Abirami Arts& Science College ,Gudiyatham</li>
                      <li><span class="ion-ios-telephone"></span> 0416-252562</li>
                      <li><span class="ion-email"></span> Abramicollege@gmail.com</li>
                    </ul>
                  </div>
                  <div class="socials">
                    <ul>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="copyright-box">
              <p class="copyright">&copy; Copyright <strong>Royal Wedding Party</strong>. All Rights Reserved</p>
              <div class="credits">
                <!--
  ...
  <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel" style="font-weight: bold;color: #C21A2B;font-size: 23px;">Payment</h5>
      </div>
      <div class="modal-body">
		<table style="font-size:18px;width: 100%;">
			<tr style="height:10px;">
				<td style="width:30%;text-align:right;font-weight:bold;padding-right:10px;">Card Number :<br><br> </td>
				<td style="width:70%;vertical-align: top;"><input type="text" autocomplete="off" name="cardnumber" id="cardnumber" value="" class="form-control" maxlength="16"></td>
			</tr>
			<tr style="height:10px;">
				<td style="width:30%;text-align:right;font-weight:bold;padding-right:10px;">Exp Date :<br><br> </td>
				<td style="width:70%;vertical-align: top;">
					<select id="expmonth" class="l">
						<?php for($i=1; $i<=12; $i++) { ?>
							<option value="<?php echo $i; ?>"><?php echo $i; ?></option>
						<?php } ?>
					</select>
					<select id="expyear" class="l">
						<?php for($i=2024; $i<=2027; $i++) { ?>
							<option value="<?php echo $i; ?>"><?php echo $i; ?></option>
						<?php } ?>
					</select>
			</tr>
			<tr style="height:10px;">
				<td style="width:%;text-align:right;font-weight:bold;padding-right:10px;">CVV :<br><br> </td>
				<td style="width:%;vertical-align: top;"><input type="password" autocomplete="off" name="cardnumbercvv" id="cardnumbercvv" value="" class="form-control" maxlength="3">
				<input type="hidden" autocomplete="off" name="cardnumberreg_id" id="cardnumberreg_id" value="" class="form-control" maxlength="10"></td>
			</tr>
			<tr class="verrormodal" style="height:10px;color:red;font-size: 20px;font-weight: bold;text-align:center;display:none;">
				<td colspan="4" class="verrormodalhtml">Error</td>
			</tr>
		</table>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary" onclick="return Paybalance();">Pay Now</button>
      </div>
    </div>
  </div>
</div>
<script>
var paynowshow = function(cardnumberreg_id){
	$('#exampleModal').modal('show');
	$('#cardnumberreg_id').val(cardnumberreg_id)
}
var Paybalance = function(){
	var verror = [];
	cardnumber = $('#cardnumber').val();
	cardnumbercvv = $('#cardnumbercvv').val();
	if(cardnumber == '') {
		verror.push('Cardnumber is required');	
	}  
	if(cardnumber.length != 16) {
		verror.push('Cardnumber length must be 16 digits');	
	}
	
	if(cardnumbercvv == '') {
		verror.push('CVV is required');	
	} 
	if(cardnumbercvv.length != 3) {
		verror.push('CVV length must be 16 digits');	
	}
	
	if(verror.length == 0){
		var formData = new FormData();		
			formData.append('cardnumberreg_id', $('#cardnumberreg_id').val());
			$.ajax({
				url: "http://localhost/wedding/profile.php",
				type: 'POST',
				data: formData,
				async: true,
				processData: false,
				...
				success: function(resdata){
					...
					if(typeof response =='object') {
						...
						alert('Error Kindly Contact Owner or techinical person');
					}
				},
				error: function(){
					alert('Error Kindly Contact Owner or techinical person');	
		...
		errhtml = verror.join(', ')+" is required";
		$('.verrormodal').show();
		$('.verrormodalhtml').html(errhtml);
	}
	return false;
}
</script>
